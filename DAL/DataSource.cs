...
namespace DalObject
{
    ...
    /// </summary>
    public class DataSource//storage class for the whole company
    {
        ...
        internal class Config//starting company with value
        {
            ...
            static internal void Initialize()
            {
                BaseStation B = new BaseStation()///create new objects as asked
                {
                    ...
                    Name = "Base " + (IDAL.DO.BaseStationEmplacemt)(0), // baseInput,
                ...
                B = new BaseStation()///create new objects as asked
                {
                    ...
                    Latitude = (double)random.Next(29000000, 34000000) / (double)1000000,
                    Longitude = (double)random.Next(34000000, 35000000) / (double)1000000,
                    Name = "Base " + (IDAL.DO.BaseStationEmplacemt)(1), // baseInput,
                    NumOfSlots = random.Next(2, 4)
                };
                BaseStations.Add(B);
                B = new BaseStation()///create new objects as asked
                {
                    ...
                    Latitude = (double)random.Next(29000000, 34000000) / (double)1000000,
                    Longitude = (double)random.Next(34000000, 35000000) / (double)1000000,
                    Name = "Base " + (IDAL.DO.BaseStationEmplacemt)(2), // baseInput,
                    NumOfSlots = random.Next(2, 4)
                };
                BaseStations.Add(B);
                 IDAL.DO.Drone d = new Drone()///create new objects as asked
                {
                    Id =100001,
                    Model = ((IDAL.DO.DroneNames)random.Next(3)).ToString() + " " + 1,
                    MaxWeight = (IDAL.DO.WeightCategories)random.Next(3),
                ...
                {
                    Id = 100002,
                    Model = ((IDAL.DO.DroneNames)random.Next(3)).ToString() + " " + 2,
                    MaxWeight = (IDAL.DO.WeightCategories)random.Next(3),
                ...
                {
                    Id = 100003,
                    Model = ((IDAL.DO.DroneNames)random.Next(3)).ToString() + " " + 3,
                    MaxWeight = (IDAL.DO.WeightCategories)random.Next(3),
                ...
                {
                    Id = 100004,
                    Model = ((IDAL.DO.DroneNames)random.Next(3)).ToString() + " " + 4,
                    MaxWeight = (IDAL.DO.WeightCategories)random.Next(3),
                };
                Drones.Add(d);
                d = new Drone()///create new objects as asked
                {
                    Id = 100005,
                    Model = ((IDAL.DO.DroneNames)random.Next(3)).ToString() + " " + 5,
                    MaxWeight = (IDAL.DO.WeightCategories)random.Next(3),
                ...
                {
                    Id = 100006,
                    Model = ((IDAL.DO.DroneNames)random.Next(3)).ToString() + " " + 6,
                    MaxWeight = (IDAL.DO.WeightCategories)random.Next(3),
                };
                Drones.Add(d);
                int customersInput;
                ...
                for (customersInput = 11; customersInput >= 0; customersInput--)  // 10 min, 100 max values to initialize
                    ...
                    {
                        Id = IDAL.DO.StringAdapter.lastDigitID( customersInput),
                        //Israel coordinates range
                        Latitude = (double)random.Next(29000000, 34000000) / (double)1000000,
                        Longitude = (double)random.Next(34000000, 35000000) / (double)1000000,
                ...
                {
                    IDAL.DO.Parcel p = new Parcel()///create new objects as asked
                    {
                        DroneId = 0,
                        Id = i + 2,
                        Priority = (IDAL.DO.Priorities)random.Next(3),
